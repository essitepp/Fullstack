...
describe('total likes', () => {
  ...
  test('of list with single blog correct', () => {
    expect(listHelper.totalLikes(listWithOneBlog)).toBe(5)
  })

  test('of list with multiple blogs correct', () => {
...
describe('mostBlogs', () => {
  test('correct for list with single blog', () => {
  ...
  test('correct for list with multiple blogs', () => {
    const expectedResult = {
      author: 'Robert C. Martin',
      blogs: 3
    }
    expect(listHelper.mostBlogs(listWithManyBlogs)).toEqual(expectedResult)
  })
})
...
describe('mostLikes', () => {
  ...
  test('correct for list with multiple blogs', () => {
    ...
    expect(listHelper.mostLikes(listWithManyBlogs)).toEqual(expectedResult)
  })
})